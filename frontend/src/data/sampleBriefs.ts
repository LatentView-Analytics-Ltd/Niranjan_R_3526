/**
 * Sample campaign briefs for testing and demos
 */

import type { CampaignBrief } from '../types';

export const SAMPLE_BRIEF_B2B_SAAS: CampaignBrief = {
...
export const SAMPLE_BRIEF_B2C_RETAIL: CampaignBrief = {
...
export type SampleBriefKey = keyof typeof SAMPLE_BRIEFS;
